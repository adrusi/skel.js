(function() {
  var _, __, toString = Object.prototype.toString;
  _ = function(value) {
  ...
  _.mixin = function() {
    ...
    for (var name in mixins) {
      ...
      if (typeof mixin === "function") {
        ...
        if (_.globalize.enable && window[name] == null) window[name] = mixin;
      }
    }
  };
  ...
  _.globalize = function() {
    for (var key in _.fn) {
      if (_.fn.hasOwnProperty(key) && window[key] == null) {
        window[key] = _.fn[key];
      }
    }
  ...
  _.pollute.enable = function() {
    ...
    for (var name in _.types.number) {
      if (typeof Number.prototype[name] !== "function") {
        Number.prototype[name] = function() {
          return _.types.number[name].apply(this, [this.valueOf()].concat(Array.prototype.slice.call(arguments)));
        };
  ...
  window.skel = _;
  window.batchSkel = __;
  window.installSkel = function(skel, batch) {
    window[skel] = _;
    window[batch] = __;
  };
}());